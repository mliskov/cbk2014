...
\index{breakfast!matzo brei} \index{jewish!matzo brei} \index{matzo brei}
\ingredient{1}{}{egg}
...
\item Make the vinaigrette (see \reciperef{Mustard vinaigrette}, but with tarragon).
...
\medskip \noindent {\notefont This is our traditional first course at Thanksgiving; we serve it on a leaf of lettuce with a 
red garnish: cherry tomato, red pepper, or pomegranate seeds work well.}
\end{recipe}
...
\begin{recipe}{Asian radish salad}{10 min.}{ingredients}
\index{radish salad} \index{salad!radish salad}
\ingredient{2}{c}{{\bf radishes}, sliced thin}
\ingredient{2}{}{{\bf scallions}, sliced thin}
\ingredient{4}{T}{rice wine vinegar}
\ingredient{1 \fr12}{t}{sugar}
\ingredient{}{}{salt (to taste)}
\ingredient{\fr14}{t}{black sesame seeds}
\ingredsdone
\item Add vinegar, sugar, and salt together and heat until sugar and salt dissolve.  Do not boil.
\item Allow dressing to cool, then dress radishes and scallions
\item Garnish with sesame seeds
\stepsdone
\noindent \tip The longer the mixture sits, the more it will marinate and turn pink; will eventually pickle.
\end{recipe}
...
\index{soups!albondigas} \index{albondigas} \index{turkey meatball soup} \index{filipino!albondigas}
...
\ingredient{1}{lb}{dried \bf black beans}
...
\index{soups!matzo ball} \index{matzo ball soup} \index{jewish!matzo ball soup}
\ingredient{2}{}{eggs}
...
\begin{creditrecipe}{Minestrone}{90 minutes}{ingredients}{Alice}
\index{soups!minestrone} \index{minestrone}
\ingredient{2 \fr12}{c}{fresh or pre-cooked {\bf cranberry beans}}
...
\ingredsdone
\item Cover beans, whole garlic cloves, sage, and bacon or ham bone (if using)
 with water, bring to boil, reduce to a simmer and cook until the beans are 
tender, about {\bf ?? minutes}.
\item In the soup pot, saute chopped onion, garlic, and carrots until 
translucent.  
\item Add beans, hot peppers, zucchini, mushrooms, tomatoes, marjoram, thyme, 
salt, pepper, broth, and sliced char stems.  Bring to a boil, reduce to a 
simmer and cook for {\bf 20 minutes}.
\item Add chard leaves and cook {\bf 5-10 minutes}.
\item Serve over pasta with drizzle of olive oil and shaved parmesan.
\stepsdone
\noindent \tip Any kind of small pasta will do: ditali, small shells, or orzo for instance.
\medskip
\tip If using dried beans, soak in water overnight.
\end{creditrecipe}
...
\begin{recipe}{Spaghetti carbonara}{25 min.}{serves 4}
...
\begin{creditrecipe}{Primavera}{30 min.}{ingredients}{Alice}
\index{pasta!primavera} \index{primavera}
\ingredient{}{}{\bf spring vegetables}
\ingredient{}{}{garlic}
...
\item Thicken sauce with butter at the last minute
\stepsdone
\noindent {\notefont Primavera is all about using whatever lovely spring vegetables you can
get fresh.  Peas, asparagus, baby greens, and baby carrots are traditional.  Chives and/or garlic scapes can add
a nice variation.}
\end{creditrecipe}
...
\ingredient{2}{c}{\bf tomato sauce}
...
\stepsdone
\noindent {\notefont This is a particularly nice accompaniment for \reciperef{Spaghetti carbonara}.  Instead
of using olive oil, cook the brussels sprouts in the leftover bacon grease!}
\end{recipe}
...
\begin{creditrecipe}{Latkes}{40 mins.}{serves 6-8}{Gertie}
\index{vegetables!potatoes} \index{latkes} \index{jewish!latkes}
...
\index{vegetables!tsimmis} \index{tsimmis} \index{jewish!tsimmis}
